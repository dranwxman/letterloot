export default async function handler(req, res) {
  // CORS — the Capacitor app calls this cross-origin from capacitor://localhost.
  // Without these headers the WebView silently blocks the POST (no email, no console log).
